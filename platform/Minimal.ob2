...
IMPORT
  Windows, SYSTEM, aps := AggPlatformSupport, bas := AggBasics;
...
BEGIN
    ...
    Windows.SetWindowLong(hWnd, Windows.GWL_USERDATA, bas.agg_adr(psu));

    psu.Construct(aps.pix_format_bgr24, FALSE);
