...
BEGIN
  IF key = aps.key_f1 THEN
    ta.message(
     ...
     'The rectangle looks bad - the rounded corners are thicker than its side lines. ' + 0DX +
     'First try to drag the "subpixel offset" control - it simply adds some fractional ' + 0DX +
     'value to the coordinates. When dragging you will see that the rectangle is' + 0DX +
     '"blinking". Then increase "Gamma" to about 1.5. The result will look almost ' + 0DX +
     'perfect - the visual thickness of the rectangle remains the same. That"s good, ' + 0DX +
     'but turn the checkbox "White on black" on - what do we see? Our rounded ' + 0DX +
     'rectangle looks terrible. Drag the "subpixel offset" slider - it"s blinking as hell. ' + 0DX +
     'Now decrease "Gamma" to about 0.6. What do we see now? Perfect result! ' + 0DX +
     'If you use an LCD monitor, the good value of gamma will be closer to 1.0 in both ' + 0DX +
     "cases - black on white or white on black. There's no perfection in this world, but " + 0DX +
